		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "HappySitter",
									"targetURL": "#comapplexushappysitter-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comapplexushappysitter-display": {
								"semanticObject": "comapplexushappysitter",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.applexus.happysitter",
									"url": sap.ui.require.toUrl("com/applexus/happysitter")
								}
							}
						}
					}
